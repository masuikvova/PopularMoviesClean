...
public class ReviewCacheTransformer implements Observable.Transformer<List<Review>,List<Review>>{
    ...
    @Override
    public Observable<List<Review>> call(Observable<List<Review>> listObservable) {
